...
export declare type NavItemOverridesProps = {
    NavItem?: PrimitiveOverrideProps<ViewProps>;
    Label?: PrimitiveOverrideProps<TextProps>;
    Active?: PrimitiveOverrideProps<ViewProps>;
} & EscapeHatchProps;
export declare type NavItemProps = React.PropsWithChildren<Partial<ViewProps> & {
