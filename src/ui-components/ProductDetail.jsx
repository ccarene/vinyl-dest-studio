    ...
    >
      ...
      >
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7221379")}
          >
            <Text
              fontFamily="Inter"
              fontSize="24px"
          ...
          <View
            width="unset"
            height="1px"
            {...getOverrideProps(overrides, "Divider221382")}
          ></View>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7221383")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <View
            width="unset"
            height="1px"
            {...getOverrideProps(overrides, "Divider221386")}
          ></View>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7221387")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
      ...
      >
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 27221392")}
        >
          <Flex
            width="unset"
            height="unset"
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 27221395")}
        >
          <Text
            fontFamily="Inter"
            fontSize="14px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28221398")}
          >
            <Flex
              width="85px"
              height="unset"
              {...getOverrideProps(overrides, "Button221399")}
            ></Flex>
            <Flex
              width="87px"
              height="unset"
              {...getOverrideProps(overrides, "Button221400")}
            ></Flex>
            <Flex
              width="87px"
              height="unset"
              {...getOverrideProps(overrides, "Button221401")}
            ></Flex>
            <Flex
              width="87px"
              height="unset"
              {...getOverrideProps(overrides, "Button221402")}
            ></Flex>
          </Flex>
          <Flex
            gap="24px"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28221403")}
          >
            <Flex
              width="87px"
              height="unset"
              {...getOverrideProps(overrides, "Button221404")}
            ></Flex>
            <Flex
              width="87px"
              height="unset"
              {...getOverrideProps(overrides, "Button221405")}
            ></Flex>
            <Flex
              width="87px"
              height="unset"
              {...getOverrideProps(overrides, "Button221406")}
            ></Flex>
            <Flex
              width="87px"
              height="unset"
              {...getOverrideProps(overrides, "Button221407")}
            ></Flex>
          </Flex>
          <Flex
            width="unset"
            height="unset"
            {...getOverrideProps(overrides, "Button221408")}
          ></Flex>
        </Flex>
      </Flex>
    </Flex>
