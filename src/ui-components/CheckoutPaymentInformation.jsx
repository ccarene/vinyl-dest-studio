...
export default function CheckoutPaymentInformation(props) {
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "CheckoutPaymentInformation")}
      {...rest}
    >
      <Flex
        gap="48px"
      ...
      >
        <Flex
          ...
          backgroundColor="rgba(255,255,255,1)"
          {...getOverrideProps(overrides, "Frame 411113748")}
        >
          <Flex
            gap="32px"
            direction="column"
          ...
          >
            ...
            >
              <Flex
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "TextField113805")}
              >
                <Text
                  fontFamily="Inter"
                  fontSize="16px"
                  ...
                  {...getOverrideProps(overrides, "label113806")}
                ></Text>
                <Flex
                  gap="0"
                  direction="column"
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "InputGroup113808")}
                >
                  <Flex
                    gap="10px"
                    direction="column"
                    ...
                    {...getOverrideProps(overrides, "Input113809")}
                  >
                    <Text
                      fontFamily="Inter"
                      fontSize="16px"
                      ...
                      whiteSpace="pre-wrap"
                      children=""
                      {...getOverrideProps(overrides, "placeholder113810")}
                    ></Text>
                  </Flex>
                </Flex>
              </Flex>
              ...
              >
                <Flex
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "TextField113812")}
                >
                  <Text
                    fontFamily="Inter"
                    fontSize="16px"
                    ...
                    whiteSpace="pre-wrap"
                    children="Expiration"
                    {...getOverrideProps(overrides, "label113813")}
                  ></Text>
                  <Flex
                    gap="0"
                    direction="column"
                    ...
                    position="relative"
                    padding="0px 0px 0px 0px"
                    {...getOverrideProps(overrides, "InputGroup113815")}
                  >
                    <Flex
                      gap="10px"
                      direction="column"
                      ...
                      borderRadius="5px"
                      padding="8px 16px 8px 16px"
                      {...getOverrideProps(overrides, "Input113816")}
                    >
                      <Text
                        fontFamily="Inter"
                        fontSize="16px"
                        ...
                        whiteSpace="pre-wrap"
                        children=""
                        {...getOverrideProps(overrides, "placeholder113817")}
                      ></Text>
                    </Flex>
                  </Flex>
                </Flex>
                <Flex
                  ...
                  position="relative"
                  padding="0px 0px 0px 0px"
                  {...getOverrideProps(overrides, "TextField113819")}
                >
                  <Text
                    fontFamily="Inter"
                    fontSize="16px"
                    ...
                    whiteSpace="pre-wrap"
                    children="CVC"
                    {...getOverrideProps(overrides, "label113820")}
                  ></Text>
                  <Flex
                    gap="0"
                    direction="column"
                    ...
                    position="relative"
                    padding="0px 0px 0px 0px"
                    {...getOverrideProps(overrides, "InputGroup113822")}
                  >
                    <Flex
                      gap="10px"
                      direction="column"
                      ...
                      borderRadius="5px"
                      padding="8px 16px 8px 16px"
                      {...getOverrideProps(overrides, "Input113823")}
                    >
                      <Text
                        fontFamily="Inter"
                        fontSize="16px"
            ...
            <Flex
              ...
              position="relative"
              padding="0px 32px 0px 32px"
              {...getOverrideProps(overrides, "Frame 411113759")}
            >
              <Flex
                gap="0"
                direction="row"
